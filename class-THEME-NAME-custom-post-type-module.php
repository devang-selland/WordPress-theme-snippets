 ...
 *
 * @package WordPress
 * @subpackage THEME PACKGE
 * @since THEME NAME 1.0
*/
// Enable module / Disable Module theme option field
if ( ! class_exists( 'THEME_NAME_ACF_Custom_Post_Type_Module' ) ) {
    class THEME_NAME_ACF_Custom_Post_Type_Module{

        private $text_doamin = 'THEME_TEXTDOMAIN';

        /* Class constructor */
        public function __construct()
        {
            add_action( 'init', array( $this, 'THEME_NAME_register_post_type' ) );
            add_action( 'init',array( $this,'THEME_NAME_add_taxonomy') );		
        }

        public function THEME_NAME_custom_get_post_types() {
        ...
        public function THEME_NAME_custom_get_category_types() {
        ...
        public function THEME_NAME_register_post_type() {

            $posttypes = $this->THEME_NAME_custom_get_post_types();
        ...
        public function THEME_NAME_add_taxonomy() {
            
            $custom_taxonomies = $this->THEME_NAME_custom_get_category_types();
...
new THEME_NAME_ACF_Custom_Post_Type_Module();
