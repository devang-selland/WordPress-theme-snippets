...
*/
if ( ! class_exists( 'THEME_NAME_ACF_Theme_Functions' ) ) {

    /**
	 * ACF Custom Theme Functions
	 */
	class THEME_NAME_ACF_Theme_Functions {

        public function __construct() {

            // base theme setup function
            add_action( 'after_setup_theme', array( $this, 'THEME_NAME_setup' ) );      
            
            // base theme widget
            add_action( 'widgets_init', array( $this,'THEME_NAME_widgets_init' ) );

            // body class hook to add page slud to body class
            add_filter( 'body_class', array( $this,'THEME_NAME_add_slug_body_class' ) );
         ...
         *
         */
        public function THEME_NAME_setup() {
            /*
         ...
         */
        public function THEME_NAME_widgets_init() {
            register_sidebar(
                array(
        ...
        */
        public function THEME_NAME_add_slug_body_class( $classes ) {
...
new THEME_NAME_ACF_Theme_Functions();
?>
